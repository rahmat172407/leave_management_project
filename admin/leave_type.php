<?php
require('../front/partials/top.php');
if($_SESSION['ROLE']!=1){
                              ...
                              <table class="table ">
                                 ...
                                 <tbody>
									...
									<tr>
									   ...
									   <td><a href="add_leave_type.php?id=<?php echo $row['id']?>" class="btn btn-primary">Edit</a> <a href="leave_type.php?id=<?php echo $row['id']?>&type=delete" class="btn btn-danger">Delete</a></td>
                                    </tr>
									<?php 
									$i++;
									} ?>
...
<?php
require('../front/partials/footer.php');
?>