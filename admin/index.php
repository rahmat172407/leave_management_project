                        ...
                        <div class="card-body--">
                           <div class="table-stats order-table ov-h">
                              ...
                              <td><?php echo $row['department']?></td>
									   <td><a href="add_department.php?id=<?php echo $row['id']?>" class="btn btn-primary">Edit</a>
                               <a href="index.php?id=<?php echo $row['id']?>&type=delete" class="btn btn-danger">Delete</a></td>
                           </tr>
									<?php 
									$i++;
									} ?>
